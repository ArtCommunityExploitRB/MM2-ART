...
-- ==========================================
local UIConfig = {
    MainWidth = 450,        -- Сделал чуть шире для баланса
    MainHeight = 380,       -- Значительно увеличил высоту ("удлинил вниз")
    SidebarWidth = 110,     -- Увеличил боковую панель под размер окна
    ButtonHeight = 42,      -- Кнопки стали еще удобнее для пальцев
    FontSize = 14,          -- Оставил комфортный размер текста
    SliderHeight = 60,      -- Увеличенная зона для слайдеров
    ScrollThickness = 4,    -- Заметный скроллбар
    TabBtnHeight = 40       -- Пропорциональные кнопки вкладок
}
